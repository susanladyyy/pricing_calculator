...
@section('content')
    <div class="nav-body w-full px-[10vw] py-[2vh] min-h-[80vh]">
        <h1 class="mb-10 mt-10 text-4xl font-bold">Update University</h1>

        <form action="{{ route('postUpdateUniversity', ['id' => $university->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" value="{{ $university->university_name }}" name="oldLogo">
            @error('name')
            ...
            <div class="field mb-[3vh]">
                <div class="border border-black shadow-md rounded-md overflow-hidden">
                    <input class="w-full border-x-0 border-t-0" value="{{ $university->university_name }}" type="text"
            ...
            <div class="field mb-[3vh]">
                <div class="border border-black shadow-md rounded-md overflow-hidden">
                    <input class="w-full border-x-0 border-t-0" value="{{ $university->university_address }}" type="text"
            ...
            <div class="field mb-[3vh]">
                <div class="border border-black shadow-md rounded-md overflow-hidden">
                    <input class="w-full border-x-0 border-t-0" value="" type="file"
                        id="" name="logo"/>
            ...
            <div class="w-full border border-black shadow-md rounded-md overflow-hidden">
                <input class="cursor-pointer w-full bg-primary text-white px-[1vw] py-[1vh] rounded-md shadow-md" value="Update University" type="submit">
            </div>
        </form>
    </div>
@endsection
